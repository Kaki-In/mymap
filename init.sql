...
--
-- Table structure for table `BlockTests`
--

DROP TABLE IF EXISTS `BlockTests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `BlockTests` (
...
-- Dump completed on 2022-06-30 11:33:43
